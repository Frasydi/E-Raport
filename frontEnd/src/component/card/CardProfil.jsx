...
const CardProfil = ({image, fullName, lastName, gender, kelas}) => {
    ...
    return (
        <div className="w-52 h-80 bg-gradient-to-br from-white to-gray-100 rounded-3xl shadow-xl p-3 flex flex-col items-center justify-between border border-gray-200 relative">
